...
2) Patients should take their meds regularly if prescribed. Otherwise, their condition may worsen: 
	...
	Beta-blockers : Acute Heart failure = oedema, shortness of breath, can't run. 
		Instead of family medical history (useless gameplay wise), maybe change to personal medical history ? If patient has migraines, not taken betablockers will lead to headaches. If patient has chronic heart failure, not taking them will lead to acute heart failure. If patient has essential tremor (NEW), not taking them leads to hands shaking and dropping items on the floor regularly. 

3) Some players should spawn without their meds (people often couldn't get an appointment fast enough to renew them, or forget them when travelling). This would lead to more early round gameplay for medical with a few patients coming in to renew their prescriptions (RP).

4) All of the above extends the medical gameplay on what has already been put in the customization screen, but is unique compared to the basic 4 or 5 type of damages already in the game.
...
5) Would lead to interesting RP with CMO doing rounds for interns?
